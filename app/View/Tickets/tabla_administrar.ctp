			...
			<table class="table tabla-condensed table-striped">
				...
				<td class="actions">
					<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $ticket['Ticket']['id']), array('class' => 'btn btn-sm btn-danger', 'confirm' => __('Realmente desea eliminar el ticket: %s?', $ticket['Ticket']['id']))); ?>
				</td>

<div class="box box-primary box-solid">
  <div class="box-header with-border">
    <h3 class="box-title"><i class="fa fa-user"></i> Registrar Punto</h3>
  ...
  <div class="box-body">
    <?php echo $this->Form->create('Bancopunto'); 
    ?>
    <fieldset>
      <legend><?php echo __('Datos generales'); ?></legend>

      <div class="row-fluid">
        <div class="col-md-4"><?php echo $this->Form->input('nombre', array('label' => 'Denominación', 'class' => 'form-control', 'placeholder' => 'Denominación')); ?>
        </div>       
      </div>   
      <div class="row-fluid">
                  <div class="col-md-4">
                    <div class="checkbox">
                      <label>
                        <?php echo $this->Form->input('estado', array('type' => "checkbox", 'label' => "Estado", 'default' => True)); ?>
                      </label>
                    </div>
                  </div>
              </div>   
